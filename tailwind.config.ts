...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        primary: {
          DEFAULT: '#dda15e',   /* Mapped primary accent to Earth Yellow */
          50: '#fcf6ef',
          100: '#f9ecdf',
          200: '#f6e3d0',
          300: '#f3dac0',
      ...
      backgroundImage: {
        ...
        'neon-gradient': 'linear-gradient(135deg, #dda15e, #bc6c25)',
        'yellow-black': 'linear-gradient(180deg, #dda15e, #0B0B0C)',
        'gold-gradient': 'linear-gradient(135deg, #dda15e, #bc6c25)',
      },
      animation: {
